package com.example.metroinfo.data.network
...
interface ApiService {
    ...
    @GET("api/arrival-time/line/{lineId}")
    suspend fun getLineStationsWithArrivalTime(@Path("lineId") lineId: Int): Response<List<ArrivalTimeInfo>>

    @GET("api/arrival-time/search")
    suspend fun searchStationsWithArrivalTime(@Query("q") query: String): Response<List<ArrivalTimeInfo>>
